...
export default function Licenses() {
  ...
  useEffect(() => {
    axios
      .get("https://administracionalpha.com/api/company")
      .then((response) => {
  ...
  const handleAddLicense = async () => {
    ...
    try {
      const response = await axios.post("https://administracionalpha.com/api/company/", payload, {
  ...
  const handleDeleteLicense = async (id:any) => {
    try {
      await axios.delete(`https://administracionalpha.com/api/company/${id}`);
